...
foounit.add(function (kw){ with (kw){
  ...
  it('can give any existing class a monadic interface without conflicting', function (){
    ...
    monad.create(MyClass, global)
      .init('chain', function (){})
      .func('inc',   MyClass.prototype.inc)
      .func('dec',   MyClass.prototype.dec)
      .exec('value', MyClass.prototype.value);
  ...
  describe('.wrap', function (){
    ...
    xit('excludes wrapping functions that are specifiied', function (){
    });
  });
